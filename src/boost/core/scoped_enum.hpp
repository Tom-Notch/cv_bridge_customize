...
template <typename EnumType>
inline
    typename EnumType::enum_type
    native_value(EnumType e)
{
...
template <typename EnumType>
inline EnumType native_value(EnumType e)
{
  return e;
}
...
#define BOOST_SCOPED_ENUM_UT_DECLARE_CONVERSION_OPERATOR   \
  explicit operator underlying_type() const BOOST_NOEXCEPT \
  {                                                        \
...
#define BOOST_SCOPED_ENUM_UT_DECLARE_BEGIN(EnumType, UnderlyingType) \
  ...
  {                                                                  \
    ...
    underlying_type get_underlying_value_() const BOOST_NOEXCEPT     \
    {                                                                \
      return v_;                                                     \
    }                                                                \
...
#define BOOST_SCOPED_ENUM_DECLARE_END2()                              \
  enum_type get_native_value_() const BOOST_NOEXCEPT                  \
  {                                                                   \
    return enum_type(v_);                                             \
  }                                                                   \
  friend bool operator==(self_type lhs, self_type rhs) BOOST_NOEXCEPT \
  {                                                                   \
    return enum_type(lhs.v_) == enum_type(rhs.v_);                    \
  }                                                                   \
  friend bool operator==(self_type lhs, enum_type rhs) BOOST_NOEXCEPT \
  {                                                                   \
    return enum_type(lhs.v_) == rhs;                                  \
  }                                                                   \
  friend bool operator==(enum_type lhs, self_type rhs) BOOST_NOEXCEPT \
  {                                                                   \
